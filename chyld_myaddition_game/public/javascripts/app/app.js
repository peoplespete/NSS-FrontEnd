...
function htmlAddPlayer(player){
  ...
  var $player = $('<div>').addClass('player').css('background-color', player.color).text(player.name);
  var $health = $('<div>').addClass('health').css('width', player.health + '%').css('background-color', 'black');
  $cell.prepend($player, $health);

  console.log($cell.find('.player').length);
